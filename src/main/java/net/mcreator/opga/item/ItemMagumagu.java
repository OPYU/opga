...
public class ItemMagumagu extends ElementsOpgaMod.ModElement {
	@GameRegistry.ObjectHolder("opga:magumagu")
	public static final Item block = null;
	public ItemMagumagu(ElementsOpgaMod instance) {
		super(instance, 93);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("opga:magumagu", "inventory"));
	}
	public static class ItemFoodCustom extends ItemFood {
		public ItemFoodCustom() {
			super(4, 0.3f, false);
			setUnlocalizedName("magumagu");
