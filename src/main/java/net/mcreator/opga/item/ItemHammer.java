...
public class ItemHammer extends ElementsOPGA.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("HAMMER", 1, 100, 4f, 0f, 2)) {
			@Override
		...
		}.setUnlocalizedName("hammer").setRegistryName("hammer").setCreativeTab(TabOPGA.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("opga:hammer", "inventory"));
	}
}
