...
public class ItemKaizoku extends ElementsOpgaMod.ModElement {
	...
	public void initElements() {
		...
		}.setUnlocalizedName("kaizoku").setRegistryName("kaizoku").setCreativeTab(TabOPGA.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("opga:kaizoku", "inventory"));
	}
}
