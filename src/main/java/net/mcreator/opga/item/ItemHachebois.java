...
public class ItemHachebois extends ElementsOpgaMod.ModElement {
	...
	public void initElements() {
		...
		}.setUnlocalizedName("hachebois").setRegistryName("hachebois").setCreativeTab(TabOPGA.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("opga:hachebois", "inventory"));
	}
	private static class ItemToolCustom extends ItemTool {
		...
		protected ItemToolCustom() {
			super(EnumHelper.addToolMaterial("HACHEBOIS", 1, 100, 4f, 0f, 2), effective_items_set);
