...
public class ItemKikoku extends ElementsOPGA.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("KIKOKU", 1, 100, 4f, 0f, 2)) {
			@Override
		...
		}.setUnlocalizedName("kikoku").setRegistryName("kikoku").setCreativeTab(TabOPGA.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("opga:kikoku", "inventory"));
	}
}
