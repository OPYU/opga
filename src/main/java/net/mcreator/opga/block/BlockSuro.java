...
public class BlockSuro extends ElementsOPGA.ModElement {
	@GameRegistry.ObjectHolder("opga:suro")
	public static final Block block = null;
	public BlockSuro(ElementsOPGA instance) {
		super(instance, 143);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("opga:suro", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("suro");
			setRegistryName("suro");
		}
