...
public class BlockHerbebrillante extends ElementsOpgaMod.ModElement {
	@GameRegistry.ObjectHolder("opga:herbebrillante")
	public static final Block block = null;
	public BlockHerbebrillante(ElementsOpgaMod instance) {
		super(instance, 148);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("opga:herbebrillante", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("herbebrillante");
			setRegistryName("herbebrillante");
		}
