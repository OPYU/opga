...
public class BlockHakike extends ElementsOpgaMod.ModElement {
	@GameRegistry.ObjectHolder("opga:hakike")
	public static final Block block = null;
	public BlockHakike(ElementsOpgaMod instance) {
		super(instance, 147);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("opga:hakike", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("hakike");
			setRegistryName("hakike");
		}
