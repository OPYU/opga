...
public class BlockKareru extends ElementsOpgaMod.ModElement {
	@GameRegistry.ObjectHolder("opga:kareru")
	public static final Block block = null;
	public BlockKareru(ElementsOpgaMod instance) {
		super(instance, 145);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("opga:kareru", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("kareru");
			setRegistryName("kareru");
		}
