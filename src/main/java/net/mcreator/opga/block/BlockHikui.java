...
public class BlockHikui extends ElementsOpgaMod.ModElement {
	@GameRegistry.ObjectHolder("opga:hikui")
	public static final Block block = null;
	public BlockHikui(ElementsOpgaMod instance) {
		super(instance, 146);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("opga:hikui", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("hikui");
			setRegistryName("hikui");
		}
