...
public class BlockKufuku extends ElementsOpgaMod.ModElement {
	@GameRegistry.ObjectHolder("opga:kufuku")
	public static final Block block = null;
	public BlockKufuku(ElementsOpgaMod instance) {
		super(instance, 144);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("opga:kufuku", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("kufuku");
			setRegistryName("kufuku");
		}
