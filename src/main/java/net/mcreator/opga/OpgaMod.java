 ...
 *
 *    Keep the ElementsOpgaMod object in this class and all calls to this object
...
@Mod(modid = OpgaMod.MODID, version = OpgaMod.VERSION)
public class OpgaMod {
	...
	@SidedProxy(clientSide = "net.mcreator.opga.ClientProxyOpgaMod", serverSide = "net.mcreator.opga.ServerProxyOpgaMod")
	public static IProxyOpgaMod proxy;
	@Mod.Instance(MODID)
	public static OpgaMod instance;
	public ElementsOpgaMod elements = new ElementsOpgaMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsOpgaMod.GuiHandler());
